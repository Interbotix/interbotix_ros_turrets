...
def main():
    robot = InterbotixTurretXS(robot_model="pxxls", pan_profile_type="time", tilt_profile_type="time")
    ...
    # then wait until the motion finishes to return control to the user
    robot.turret.tilt(position=1.5, profile_velocity=1.5, profile_acceleration=0.3, blocking=True)
    ...
    robot.turret.pan_tilt_move(-0.8, -1, pan_profile_velocity=1.0, pan_profile_acceleration=0.4, tilt_profile_velocity=2.0, tilt_profile_acceleration=1.0)
