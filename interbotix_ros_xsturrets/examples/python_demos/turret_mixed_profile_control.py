...
def main():
    ...
    robot = InterbotixTurretXS(robot_model="pxxls", pan_profile_type="time", tilt_profile_type="velocity")
    ...
    robot.turret.pan(position=1.0, profile_velocity=1.0, profile_acceleration=0.5, blocking=True)
    ...
    robot.turret.pan_tilt_move(-0.8, -1, pan_profile_velocity=1.0, pan_profile_acceleration=0.4, tilt_profile_velocity=33, tilt_profile_acceleration=0, delay=3.0)
